<?php
/**
 * Register Custom Elements Page and Tab
 *
 * @sinc 4.8
 */
 ...
 * ===================
 *
 * Can be used in case we register tabs only with include file
 */

//$avia_pages[] = array(
//			'slug'		=> 'avia_element_templates',
//			'parent'	=> 'avia',
//			'icon'		=> 'new/custom-elements-7@3x.png',
//			'title'		=>  __( 'Custom Elements', 'avia_framework' )
//	);


/**
 * Custom Elements Tab Content
 * ===========================
 */
 ...
 * @param string $context
 */
do_action( 'ava_theme_options_elements_tab', 'avia_element_templates' );
